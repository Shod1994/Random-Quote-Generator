...
document.querySelector(".quote-btn").addEventListener("click", randomQuote);

function randomQuote() {
  // Select Random Number
  randomNumber = Math.floor(Math.random() * quotesDisplay.length);

  document.querySelector("p").innerHTML = quotesDisplay[randomNumber];
}
});
